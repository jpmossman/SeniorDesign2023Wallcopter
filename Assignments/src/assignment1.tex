...
\begin{document}
    ...
    \section{Overview}
        ...
        \subsection{Project Goals}
            The aim of this project is to develop a drone that can touch or get very close to the bottom side of a bridges or high rise buildings for inspection purposes. We are looking to make at least a prototype that can go up to the ceilings of most areas and can navigate via a wireless control system. Our priority is as follows: main focus on functionality, producing a minimum working prototype, and then try to reduce the cost of the drone itself if possible.
    ...
    \section{Engineering Requirements}
        \begin{longtable}{ | m{4.25cm} | m{5cm}| m{5.4cm} | }
            ...
            4 &
            The device should be within a reasonable price range of around \$50-\$250. &
            ...
            6 &
            The wall-copter should be able to run for at least 15-20 minutes and is rechargeable. &
