/*
 * Nearly identical to the stock Adafruit_Sensor.h
 * esp_camera.h defines sensor_t, and so does this. One of them must change,
 * so this file has sensor_t changed to sensor2_t
*/
/*
...
public:
  ...
  virtual void getSensor(sensor2_t *) = 0;
